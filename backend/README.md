...
## Project Structure
    ...
    ├── testapiautocatalog_127591  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_127591`
...
2. Clone this repo and `cd testapiautocatalog_127591`
